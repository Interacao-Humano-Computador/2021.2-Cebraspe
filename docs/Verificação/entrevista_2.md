# Verificação de Entrevista 2

## Histórico de versão

|Versão | Data | Descrição | Autor|  Revisor |
| :--: | :--: | :--: | :--: | :--:  |
| 0.1 | 05/04/2022  | Criação do documento de verificação de Perfil de Usuário | Daniel |  Ana Carolina |

## 1. Introdução
<p style="text-align: justify;"> A Verificação é uma atividade, a qual envolve a análise de um sistema para certificar se este atende aos requisitos funcionais e não funcionais. Com isso, temos o objetivo de verificar os erros encontrados no documento de Entrevista 2.
</p>
...
| :--: | -- | :--: |
| 1 | O vídeo está claro de ser entendido? | OK |
| 2 | Ortografia segue padrão? | OK |
| 3 | Existe uma explicação para informações do vídeo? | OK |
| 5 | Existe rastreabilidade? | OK |
| 6 | A entrevista seguiu passos definido pelos documentos? | OK |
