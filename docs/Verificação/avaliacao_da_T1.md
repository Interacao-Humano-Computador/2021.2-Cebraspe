...
## 1. Introdução
<p style="text-align: justify;"> A Verificação é uma atividade, a qual envolve a análise de um sistema para certificar se este atende aos objetivos do documento. Com isso, temos o objetivo de verificar os erros encontrados no documento de Avaliação da Tarefa 1.
</p>
