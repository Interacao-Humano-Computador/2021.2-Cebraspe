...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="persona" colspan="8">Persona Primária.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan=8 class="persona">Nezuko nessecita do Cebraspe para se matricular no vestibular da UnB.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td class="titulo"><strong>Objetivos:</strong></td>
            <td colspan="1" class="persona">Passar no concurso para a Polícia Militar do DF.<br>Dar boa vida para o filho.</td>
        </tr>
        <tr>
            <td class="titulo"><strong>Relacionamentos:</strong></td>
        ...
        <tr>
            <td class="titulo"><strong>Status:</strong></td>
            <td class="persona" colspan="8">Persona Secundária.</td>
        </tr>
        <tr>
            <td class="titulo"><strong>Habilidades:</strong></td>
        ...
        <tr>
            <td><strong>Tarefas:</strong></td>
            <td colspan=8 class="persona">Acorda cedo para ir para o trabalho. Trabalha cerca de 8 horas por dia como atendente de uma loja de ferramentas.</td>
        </tr>
        <tr>
            <td><strong>Expectativas:</strong></td>
            <td colspan=8 class="persona">Zenitsu que ter facilidade para ver o resultado do concurso que já realizou.</td>
        </tr>
    </tbody>
</table>
