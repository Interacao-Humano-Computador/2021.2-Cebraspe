...
| 2.2 Vá em Mais Informações                             | **Input**: opções de subprogramas encontradas; <br> **Action**: clicar no botão de mais informações; <br> **Feedback**: aparecerá mais informações do subprograma selecionado em uma nova tela na mesma aba.o |
