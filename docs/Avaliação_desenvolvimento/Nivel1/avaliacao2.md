# Avaliação 2: Verificar o Gabarito de uma Prova do PAS
...
### 4.2 Acessar "Acesso à universidade"
* **Essa ação está representada de alguma forma no diagrama HTA ?**<br>
...
### 4.5 Escolher etapa do subprograma desejado;
* **Essa ação está representada de alguma forma no diagrama HTA ?**<br>
Sim, está representada no diagrama.
...
### 4.6 Clicar em mais informações;
* **Essa ação está representada de alguma forma no diagrama HTA ?**<br>
Não.
...
### 4.7 Identificar a sessão "GABARITOS E PROVAS"
* **Essa ação está representada de alguma forma no diagrama HTA ?**<br>
Sim, está representada no diagrama
...
### 4.8 Escolher a parte da prova que deseja visualizar
* **Essa ação está representada de alguma forma no diagrama HTA ?**<br>
Não.
...
### 4.9 Escolher qual o tipo de gabarito
* **Essa ação está representada de alguma forma no diagrama HTA ?**<br>
Não.
...
### 4.10 Navegar pelo PDF do resultado
* **Essa ação está representada de alguma forma no diagrama HTA ?**<br>
Sim, está representada no diagrama.
